...
char catagories[][15] = {"Samsung", "Apple", "Xiaomi", "Vivo", "OPPO", "Tecno"};
...

{
	...
	printf(" BRAND     ID    MODEL NAME    AVAILABILITY  QUANTITY   PRICE ");
